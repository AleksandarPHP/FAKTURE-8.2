...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'prefix' => 'Prefiks',
        'suffix' => 'Sufiks',
        'client_company' => 'Naziv firme klijenta',
        'time' => 'Vreme',
        'operator' => 'Operater',
        ...
        'jib' => 'JIB',
        'email' => 'Email',
        'categories_id' => 'Odaberite kategoriju',
        'name' => 'Naziv',
        'mijerna_jedinica' => 'Mjerna jedinica',
        'kolicina' => 'Količina',
        'inv_number' => 'Broj fakture',
        'hidden_data' => 'Dodajte robu',
        'lang' => 'Jezik fakture'
    ],
];
