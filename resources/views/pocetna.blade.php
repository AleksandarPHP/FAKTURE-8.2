    ...
    <div class="col app_content_right">
      ...
      <div class="row">
          ...
          <a href="{{ url('/') }}" class="link_box">
            <i class="fa-solid fa-house fa-2xl" style="color: #4a8fac;"></i>
            <h2>Početna</h2>
            <span><i class="fas fa-arrow-right"></i></span>
          </a>
        </div>        <div class="col-md-4">
          <a href="{{ url('fakture') }}" class="link_box">
            <i class="fa-solid fa-file fa-2xl" style="color: #4a8fac;"></i>
            <h2>Fakture</h2>
            <span><i class="fas fa-arrow-right"></i></span>
          </a>
        </div>        <div class="col-md-4">
          <a href="{{ url('klijenti') }}" class="link_box">
            <i class="fa-solid fa-people-group fa-2xl" style="color: #4a8fac;"></i>
            <h2>Klijenti</h2>
            <span><i class="fas fa-arrow-right"></i></span>
          </a>
        </div>        <div class="col-md-4">
          <a href="{{ url('usluge') }}" class="link_box">
           <i class="fa-solid fa-chart-column fa-2xl" style="color: #4a8fac;"></i>
            <h2>Usluge</h2>
            <span><i class="fas fa-arrow-right"></i></span>
          </a>
        </div>        <div class="col-md-4">
          <a href="{{ url('repeat-fakture') }}" class="link_box">
            <i class="fa-solid fa-repeat fa-2xl" style="color: #4a8fac;"></i>
            <h2>Ponavljajuća faktura</h2>
            <span><i class="fas fa-arrow-right"></i></span>
          </a>
        </div>        <div class="col-md-4">
          <a href="{{ url('postavke') }}" class="link_box">
            <i class="fa-solid fa-gear fa-2xl" style="color: #4a8fac;"></i>
            <h2>Postavke</h2>
            <span><i class="fas fa-arrow-right"></i></span>
          </a>
        </div>
        ...
        <div class="col-md-4">
          <a href="{{ url('moj-profil') }}" class="link_box">
            <i class="fa-solid fa-user fa-2xl" style="color: #4a8fac;"></i>
            <h2>Moj profil</h2>
            <span><i class="fas fa-arrow-right"></i></span>
          </a>
        </div>
